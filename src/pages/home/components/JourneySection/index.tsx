...
export const JourneySection = ({
 ...
 return (
  <div className={`relative ${className}`}>
   <div
    ref={containerRef}
    className="h-[200vh] md:h-[250vh] lg:h-[700vh] relative bg-gray-100 dark:bg-gray-900"
   >
    <div className="pin-target sticky top-0 h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
       <div className="relative h-[400px] md:h-[500px] w-full lg:max-w-2xl order-2 lg:order-1">
        {workEnvironments.map((env, index) => (
         ...
         >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold text-foreground">
           {env.title}
          </h2>

          <p className="text-sm sm:text-base md:text-md lg:text-lg text-muted-foreground">
           {env.description}
          </p>
         </div>
        ))}
