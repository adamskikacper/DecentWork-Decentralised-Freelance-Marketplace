...
export const JobForm: React.FC<JobFormProps> = ({
  ...
  const skillSuggestions = [
    "React", "TypeScript", "Node.js", "Python", "Solidity", "Web3",
    "UI/UX Design", "Figma", "Blockchain", "Smart Contracts"
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <Select
              ...
              onValueChange={(value) => updateField("experienceLevel", value as ExperienceLevel)}
            >
          ...
          >
            <Select
              ...
              onValueChange={(value) => updateField("jobDuration", value as JobDuration)}
            >
