...
/**
 * Jobs - Freelancer jobs component
 * Displays a list of the freelancer's active and completed jobs
 */
const Jobs: React.FC<JobsProps> = ({
 isLoading = false,
 onMessage,
 onJobDetails,
 // onClientDetails is not used in this component but kept for API consistency
 // eslint-disable-next-line @typescript-eslint/no-unused-vars
 onClientDetails,
}) => {
 // Sample jobs data - would come from API in a real app
 const allJobs = [
  {
   id: "job1",
